...
export const useDamAssetAsImage = (damAsset) => {
  ...
  const url = damMetadata.find(
    (e) => e.metadataKey === "directImageUrl"
  ).metadataValue;
  ...
  return {
    ...
    height,
    width,
    altText: damMetadata.find((e) => e.metadataKey === "altText").metadataValue,
    thumb: damMetadata.find((e) => e.metadataKey === "thumbnailUrl")
      .metadataValue,
  };
};
