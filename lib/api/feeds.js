...
export const supportedTypes = ["staffProfiles", "news", "events"];
...
export async function generateFeed({ entries, publicPath, feedTitle }) {
  ...
  const feed = new Feed({
    title: `${siteTitle}${feedTitle ? ` — ${feedTitle}` : ""}`,
