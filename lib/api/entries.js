...
import { galleryGlobalFragment } from "@/lib/api/fragments/gallery";
  ...
  if (limit !== 0) {
    switch (section) {
      ...
      case "gallery":
        ...
        query = gql`
          ${galleryGlobalFragment}
          query getGalleryGlobal($offset: Int, $inReverse: Boolean) {
            globalSet(handle: "gallery") {
              ...galleryGlobalFragment
            }
          }
        `;
        // console.log(query, offset, inReverse);
        break;
      case "galleryItems":
        theSection = section;
        theOrderBy = "dateCreated desc";
