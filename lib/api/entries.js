...
export function useDataList({
  ...
  if (limit !== 0) {
    switch (section) {
      case "events":
        theSection = `"events"`;
        theOrderBy = isSitewideSearch ? `"score"` : `"date asc"`;
        theDateFilter = `">=${today}"`;
        query = gql`
          ${eventFragment}
      ...
      case "eventsPast":
        theSection = "events";
        theOrderBy = isSitewideSearch ? "score" : "date desc";
        theDateFilter = `<${today}`;
        query = gql`
          ${eventFragment}
          ${dataListQueryify(`...eventFragment`)}
      ...
      case "galleryItems":
        ...
        theOrderBy = isSitewideSearch ? "score" : "dateCreated desc";
        query = gql`
          ${galleryItemFragment}
      ...
      case "jobs":
        theSection = "jobs";
        theOrderBy = isSitewideSearch ? "score" : "closeDate desc";
        query = gql`
          ${jobFragment}
      ...
      case "staffProfiles":
        ...
        theOrderBy = isSitewideSearch ? `"score"` : `"title"`;
        query = gql`
      ...
      default: // find a way to pass just news and pages
        theSection = null;
        theOrderBy = isSitewideSearch ? `"score"` : `"dateUpdated desc"`;
        query = gql`
          ${eventFragment}
          ${jobFragment}
          ${galleryItemFragment}
