...
import ScheduleBlockFragment from "@/services/craft/entries/content-blocks/schedule";
...
export const relatedContentFragment = print(RelatedContentBlockFragmentDoc);
...
export const scheduleBlockFragment = print(ScheduleBlockFragment);
