...
export const gameBlockFragment = `
  fragment gameBlock on contentBlocks_NeoField {
    ... on contentBlocks_game_BlockType {
      id
      typeHandle
      game
    } 
...
export const gameBlockNewsFragment = `
  fragment gameBlockNews on contentBlocksNews_NeoField {
    ...on contentBlocksNews_game_BlockType {
      id
      typeHandle
      game
    }
