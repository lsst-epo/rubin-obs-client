    ...
    <>
      {role === "teacher" ? (
        <>
          ...
          <p>
            Your account is now created, but approval is pending. You’ll receive
            an email notification once it is approved and ready to enjoy access
            to real astronomy data and tools.{" "}
            <strong>Free of charge forever.</strong>
          </p>
          <Styled.FormButtons>
