...
const NightCloudyRainThunder = ({ width, height }) => {
  const uniqueProps = {
    viewBox: "0 0 90 90",
    width: "100%",
    height: "auto",
  ...
  return (
    <svg {...mergedSvgProps}>
      ...
      <g>
        ...
        <g
          id="uuid-ad720774-8638-4238-9a62-819a8397fb9f"
          data-name="Group 5010-2"
        >
          <path
            id="uuid-148b438b-fdc7-4161-8028-88535b465350"
...
NightCloudyRainThunder.displayName = "SVG.NightCloudyRainThunder";

NightCloudyRainThunder.propTypes = svgShape;

export default NightCloudyRainThunder;
