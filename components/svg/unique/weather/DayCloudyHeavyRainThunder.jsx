...
const DayCloudyHeavyRainThunder = ({ width, height }) => {
  const uniqueProps = {
    viewBox: "0 0 90 90",
    width: "100%",
    height: "auto",
    ...
    <svg {...mergedSvgProps}>
      ...
      <g>
        ...
        <g>
          ...
          <g
            id="uuid-6b626e52-06d4-4075-b249-ffa227677bb0"
            data-name="Group 5010-2"
          >
            <path
              id="uuid-19f62e1d-695a-488d-8df0-f77d124ebda2"
...
DayCloudyHeavyRainThunder.displayName = "SVG.DayCloudyHeavyRainThunder";

DayCloudyHeavyRainThunder.propTypes = svgShape;

export default DayCloudyHeavyRainThunder;
