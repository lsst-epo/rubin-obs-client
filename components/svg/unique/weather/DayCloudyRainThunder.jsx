...
const DayCloudyRainThunder = ({ width, height }) => {
  const uniqueProps = {
    viewBox: "0 0 90 90",
    width: "100%",
    height: "auto",
...
DayCloudyRainThunder.displayName = "SVG.DayCloudyRainThunder";

DayCloudyRainThunder.propTypes = svgShape;

export default DayCloudyRainThunder;
