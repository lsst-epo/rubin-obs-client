...
const NightShowersThunderstormLikely = ({ width, height }) => {
  const uniqueProps = {
    viewBox: "0 0 90 90",
    width: "100%",
    height: "auto",
...
NightShowersThunderstormLikely.displayName =
  "SVG.NightShowersThunderstormLikely";

NightShowersThunderstormLikely.propTypes = svgShape;

export default NightShowersThunderstormLikely;
