...
const MoonGibbousWaning4 = ({
  ...
  return (
    <svg {...mergedSvgProps}>
      <title>Waning gibbous moon icon</title>
...
MoonGibbousWaning4.displayName = "SVG.MoonGibbousWaning4";

MoonGibbousWaning4.propTypes = svgShape;

export default MoonGibbousWaning4;
