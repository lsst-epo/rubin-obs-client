...
const MoonCrescentWaxing4 = ({
  ...
  return (
    <svg {...mergedSvgProps}>
      <title>Waxing crescent moon icon</title>
...
MoonCrescentWaxing4.displayName = "SVG.MoonCrescentWaxing4";

MoonCrescentWaxing4.propTypes = svgShape;

export default MoonCrescentWaxing4;
