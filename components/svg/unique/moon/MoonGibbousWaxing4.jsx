...
const MoonGibbousWaxing4 = ({
  ...
  return (
    <svg {...mergedSvgProps}>
      <title>Waxing gibbous moon icon</title>
...
MoonGibbousWaxing4.displayName = "SVG.MoonGibbousWaxing4";

MoonGibbousWaxing4.propTypes = svgShape;

export default MoonGibbousWaxing4;
