...
const MoonCrescentWaning3 = ({
  ...
  return (
    <svg {...mergedSvgProps}>
      <title>Waning crescent moon icon</title>
...
MoonCrescentWaning3.displayName = "SVG.MoonCrescentWaning3";

MoonCrescentWaning3.propTypes = svgShape;

export default MoonCrescentWaning3;
