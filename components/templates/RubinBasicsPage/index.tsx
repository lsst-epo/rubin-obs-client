...
import { env } from "@/env";
import { ReleasesService } from "@/services/noirlab";
...
const NewsPage: FunctionComponent<{
  ...
  if (pressReleaseId) {
    ...
    if (release) {
      ...
      console.info("logging description: ", description);
      ...
      return (
        <RubinBasicsPageClient data={combinedData} {...{ section, locale }} />
      );
    }
    // } else {
    //   const { data: release } =
    ...
    //     return <RubinBasicsPageClient data={combinedData} {...{ section, locale }} />;
    //   }
    // }
  }
